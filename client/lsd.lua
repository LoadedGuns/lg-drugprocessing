...
local function Processlsd()
	...
	QBCore.Functions.Progressbar("search_register", Lang:t("progressbar.processing"), 15000, false, true, {
		...
		TriggerServerEvent('lg-drugprocessing:Processlsd')
...
local function Processthionylchloride()
	...
	QBCore.Functions.Progressbar("search_register", Lang:t("progressbar.processing"), 15000, false, true, {
		...
		TriggerServerEvent('lg-drugprocessing:processThionylChloride')
...
RegisterNetEvent('lg-drugprocessing:processingThiChlo', function()
