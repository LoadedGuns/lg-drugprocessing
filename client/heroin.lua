...
local function ProcessHeroin()
	...
	QBCore.Functions.Progressbar("search_register", Lang:t("progressbar.processing"), 15000, false, true, {
		...
		TriggerServerEvent('lg-drugprocessing:processPoppyResin')
...
RegisterNetEvent('lg-drugprocessing:ProcessPoppy', function()
...
RegisterNetEvent("lg-drugprocessing:processHeroin",function()
	QBCore.Functions.TriggerCallback('lg-drugprocessing:validate_items', function(result)
		if result.ret then
			ProcessHeroin()
		else
...
RegisterNetEvent("lg-drugprocessing:pickHeroin", function()
	local playerPed = PlayerPedId()
	...
	if nearbyObject and IsPedOnFoot(playerPed) then
		...
		QBCore.Functions.Progressbar("search_register", Lang:t("progressbar.collecting"), 10000, false, true, {
			...
			TriggerServerEvent('lg-drugprocessing:pickedUpPoppy')
			isPickingUp = false
