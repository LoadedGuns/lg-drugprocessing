...
local function createChemicalMenu()
    local chemMenu = {
        ...
        },
        {
			...
			params = {
                event = "lg-drugprocessing:hydrochloric_acid",
            }
        },
        {
            ...
            txt = Lang:t("menu.chemicals"),
			params = {
                event = "lg-drugprocessing:sodium_hydroxide",
            }
        },
        {
            ...
            txt = Lang:t("menu.chemicals"),
			params = {
                event = "lg-drugprocessing:sulfuric_acid",
            }
        },
        {
...
RegisterNetEvent('lg-drugprocessing:chemicalmenu', createChemicalMenu)
...
local function process_hydrochloric_acid()
	...
	QBCore.Functions.Progressbar("search_register", Lang:t("progressbar.processing"), 15000, false, true, {
		...
		TriggerServerEvent('lg-drugprocessing:processHydrochloric_acid')
...
local function process_lsa()
	...
	QBCore.Functions.Progressbar("search_register", Lang:t("progressbar.processing"), 15000, false, true, {
		...
		TriggerServerEvent('lg-drugprocessing:process_lsa')
...
local function process_sulfuric_acid()
	...
	QBCore.Functions.Progressbar("search_register", Lang:t("progressbar.processing"), 15000, false, true, {
		...
		TriggerServerEvent('lg-drugprocessing:processprocess_sulfuric_acid')
...
local function process_sodium_hydroxide()
	...
	QBCore.Functions.Progressbar("search_register", Lang:t("progressbar.processing"), 15000, false, true, {
		...
		TriggerServerEvent('lg-drugprocessing:processsodium_hydroxide')
...
RegisterNetEvent("lg-drugprocessing:hydrochloric_acid", function()
...
RegisterNetEvent("lg-drugprocessing:lsa", function()
    QBCore.Functions.TriggerCallback('lg-drugprocessing:validate_items', function(result)
		if result then
			process_lsa()
		else
...
RegisterNetEvent("lg-drugprocessing:sulfuric_acid", function()
    QBCore.Functions.TriggerCallback('lg-drugprocessing:validate_items', function(result)
		if result then
...
RegisterNetEvent("lg-drugprocessing:sodium_hydroxide", function()
    QBCore.Functions.TriggerCallback('lg-drugprocessing:validate_items', function(result)
		if result then
...
RegisterNetEvent("lg-drugprocessing:pickChemicals", function()
	local playerPed = PlayerPedId()
	...
	if nearbyObject and IsPedOnFoot(playerPed) then
		...
		QBCore.Functions.Progressbar("search_register", Lang:t("progressbar.pickup_chemicals"), 10000, false, true, {
			...
			TriggerServerEvent('lg-drugprocessing:pickedUpChemicals')
			isPickingUp = false
