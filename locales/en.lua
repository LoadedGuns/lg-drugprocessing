local Translations = {
    ...
    success = {
        ...
        baggy = "You have successfully bagged up some drugs!",
        printedbills = "You have printed a sheet of $100 bills!",
        cutsheet = "You have cut fresh $100 bills!",
    },
    info = {
    ...
    target = {
        ...
        printsheet = "Print Sheets of Money!",
        cutsheet = "Cut Sheets of Money!",
    },
    drawtext = {
